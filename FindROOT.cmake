...
find_program(ROOT_GENREFLEX_EXECUTABLE genreflex PATHS $ENV{ROOTSYS}/bin)
find_package(GCCXML)
...
function(REFLEX_GENERATE_DICTIONARY dictionary)  
  ...
  add_custom_command(OUTPUT ${gensrcdict} ${rootmapname}     
                     COMMAND ${ROOT_GENREFLEX_EXECUTABLE} ${headerfiles} -o ${gensrcdict} ${gccxmlopts} ${rootmapopts} --select=${selectionfile}
